...
1. Тип Object
    ...
    * lec2_1.java - тип Object
    * lec2_2. java - тип Object, метод Sum для разных типов данных
...
2. Массивы
    ...
    * lec2_3.java - есть массив из двух элементов, необходимо добавить третий;
...
3. Коллекции
    ...
    * lec2_4.java - пример с Row Type и Save Type; ArrayList
    * lec2_5.java - пример с Row Type; ArrayList
    * lec2_6.java - пример с Save Type; ArrayList
    ...
    Иерархия коллекции. List
        ...
        * lec2_7.java - примеры создания ArrayList;
    ...
    * lec2_8.java - коллекция с простыми(int) и сложными(stringbuilder) типами
    ...
    * lec2_9.java - про list of и неизменяемость (нельзя remove)

3. Итератор

    * lec2_10.java - итератор, цикл foreach, while;
    * lec2_11.java - iterator (hasNext(), next(), remove());
